...
public class MyServlet extends HttpServlet {
	...
	protected void doGet(
		...
		// 요청 URI 와 URL 가져오기
		String reauestURI = request.getRequestURI();
		writer.println("요청 URI " + reauestURI);
		writer.println("<br>");
		StringBuffer reauestURL = request.getRequestURL();
		writer.println("요청 URL " + reauestURL.toString());
		writer.println("<br>");
